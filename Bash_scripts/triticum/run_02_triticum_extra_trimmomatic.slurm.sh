...
PROJECT_TABLE=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/triticum/extra_1missingfile_paired.txt # see example_samples.txt
...
OUTDIR=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/triticum/01_FastQC_raw_paired_extra # first here, after checking add to other files in 02_Trimmomatic_paired
...
# sbatch -N 1 ~/scripts/triticum/run_02_triticum_extra_trimmomatic.slurm.sh
