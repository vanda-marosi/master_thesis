...
PROJECT_TABLE=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/triticum/wheat_project_table_trimmomatic_paired.txt # see example_samples.txt
...
OUTDIR=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/triticum/02_Trimmomatic_paired
...
# sbatch -N 1 ~/scripts/triticum/run_02_triticum_paired_trimmomatic.slurm.sh
