...
PROJECT_TABLE=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/triticum/wheat_project_table.txt # see example_samples.txt
...
OUTDIR=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/triticum/01_FastQC_raw_paired
...
# sbatch -N 1 ~/scripts/triticum/run_01_triticum_paired.fastqc.slurm.sh
