...
OUTDIR=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/triticum/03_FastQC_trimmed_paired
...
# sbatch -N 1 ~/scripts/triticum/run_03_triticum_paired_fastqc.slurm.sh
