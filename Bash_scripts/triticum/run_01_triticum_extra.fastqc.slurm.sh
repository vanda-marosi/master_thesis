...
OUTDIR=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/triticum/01_FastQC_raw_paired_extra
...
# sbatch -N 1 ~/scripts/triticum/run_01_triticum_extra.fastqc.slurm.sh
