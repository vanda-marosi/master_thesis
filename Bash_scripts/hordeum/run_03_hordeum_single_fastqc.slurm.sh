...
INDIR=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/hordeum/02_Trimmomatic_single
OUTDIR=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/hordeum/03_FastQC_trimmed_single
...
# sbatch -N 1 ~/scripts/hordeum/run_03_hordeum_single_fastqc.slurm.sh
