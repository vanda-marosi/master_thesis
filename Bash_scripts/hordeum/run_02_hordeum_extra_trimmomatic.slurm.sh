...
PROJECT_TABLE=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refsets/hordeum/extra_1missingfile_paired.txt # see example_samples.txt
...
# sbatch -N 1 ~/scripts/hordeum/run_02_hordeum_extra_trimmomatic.slurm.sh
