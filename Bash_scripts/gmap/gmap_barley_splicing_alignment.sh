...
OUT=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refgenes/gmap/hordeum/barley_splicing_alignment.gff

/home/pgsb/vanda.marosi/anaconda3/envs/seqtools/bin/gmapl -D /nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/indexes/gmap -d hordeum $IN -t 4 -A > $OUT


# --nosplicing --> aligning genomic sequences onto a genome; RNAseq reads on transcriptome ...
                   
# to run: sbatch -N 1 ~/scripts/gmap/gmap_barley_splicing_alignment.sh
