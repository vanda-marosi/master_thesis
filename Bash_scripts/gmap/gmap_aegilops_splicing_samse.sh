...
OUT=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refgenes/gmap/aegilops/aegilops_splicing.samse

/home/pgsb/vanda.marosi/anaconda3/envs/seqtools/bin/gmap -D /nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/indexes/gmap -d aegilops $IN -t 4 -f samse > $OUT


# --nosplicing --> aligning genomic sequences onto a genome; RNAseq reads on transcriptome ...
                   
# to run: sbatch -N 1 ~/scripts/gmap/gmap_aegilops_splicing_samse.sh
