...
OUT=/nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/refgenes/gmap/triticum/wheat_nosplicing_alignment.gff

/home/pgsb/vanda.marosi/anaconda3/envs/seqtools/bin/gmapl -D /nfs/pgsb/projects/comparative_triticeae/phenotype/flower_development/indexes/gmap -d triticum $IN -t 4 -A --nosplicing > $OUT


# --nosplicing --> aligning genomic sequences onto a genome; RNAseq reads on transcriptome ...
                   
# to run: sbatch -N 1 ~/scripts/gmap/gmap_wheat_nosplicing_alignment.sh
